...
OUT_DIR="${OUT_DIR:-${PROJECT_ROOT}/experiments/wsi_frozen_no_empty_100ep_${timestamp}}"
mkdir -p "${OUT_DIR}"
...
echo "Protocol: WSI-level frozen train -> frozen val; final test uses eval script."
