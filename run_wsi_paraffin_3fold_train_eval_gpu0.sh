...
PARAFFIN_SRC=$'\347\237\263\350\234\241-2025'

timestamp="$(date +%Y%m%d_%H%M%S)"
RUN_ROOT="${RUN_ROOT:-${PROJECT_ROOT}/experiments/wsi_paraffin_3fold_${timestamp}}"
mkdir -p "${RUN_ROOT}"
...
echo "GPU_ID=${GPU_ID}"
echo "PARAFFIN_SRC=${PARAFFIN_SRC}"
echo "EPOCHS=${EPOCHS}"
...
echo "Protocol: 3 repeated WSI-level hold-out; tiny WSI stay in train, each large WSI is tested once."

set_fold_config() {
  case "$1" in
    fold1)
      TRAIN_WSI="2022-06-28_11_11_09.kfb,2022-06-28_11_13_25.kfb,2022-06-28_11_15_54.kfb,2022-06-28_11_18_14.kfb,2022-06-28_11_20_39.kfb"
      VAL_WSI="2022-06-28_11_14_35.kfb"
      TEST_WSI="2022-06-28_11_16_48.kfb"
      ;;
    fold2)
      TRAIN_WSI="2022-06-28_11_11_09.kfb,2022-06-28_11_13_25.kfb,2022-06-28_11_14_35.kfb,2022-06-28_11_18_14.kfb,2022-06-28_11_20_39.kfb"
      VAL_WSI="2022-06-28_11_16_48.kfb"
      TEST_WSI="2022-06-28_11_15_54.kfb"
      ;;
    fold3)
      TRAIN_WSI="2022-06-28_11_11_09.kfb,2022-06-28_11_13_25.kfb,2022-06-28_11_16_48.kfb,2022-06-28_11_18_14.kfb,2022-06-28_11_20_39.kfb"
      VAL_WSI="2022-06-28_11_15_54.kfb"
      TEST_WSI="2022-06-28_11_14_35.kfb"
      ;;
    *)
...
run_create_fold_dataset() {
  ...
  dataset_name="${PARAFFIN_SRC}-wsi-${fold}"
